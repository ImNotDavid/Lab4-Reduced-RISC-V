...
VL_ATTR_COLD void VPC___024root___settle__TOP__0(VPC___024root* vlSelf) {
    ...
    vlSelf->PC__DOT__branch_PC = ((IData)(vlSelf->jmp_sel)
                                   ? (vlSelf->PC__DOT__PCReg__DOT__current_PC 
                                      + vlSelf->ImmOp)
                                   : ((IData)(4U) + vlSelf->PC__DOT__PCReg__DOT__current_PC));
}
...
VL_ATTR_COLD void VPC___024root___ctor_var_reset(VPC___024root* vlSelf) {
    ...
    vlSelf->PC__DOT__branch_PC = VL_RAND_RESET_I(32);
    vlSelf->PC__DOT__PCReg__DOT__current_PC = VL_RAND_RESET_I(32);
}
